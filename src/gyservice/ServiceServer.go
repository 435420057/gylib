...
func (server *ServiceServer) Serve(ctx context.Context, req *service.Request) (resp *service.Response, err error) {
	...
	resp = &service.Response{Key:respKey}
	return
}
